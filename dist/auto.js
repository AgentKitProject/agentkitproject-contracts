...
export const kitRefSchema = z
    ...
    .refine((v) => v.source === "market"
    ? typeof v.marketKitId === "string"
    : typeof v.localKitId === "string", { message: "kitRef must carry marketKitId (market) or localKitId (local)" });
// ---------------------------------------------------------------------------
...
export const DENY_ALL_NETWORK_POLICY = { mode: "deny_all" };
// ---------------------------------------------------------------------------
// Approvals
// ---------------------------------------------------------------------------
/**
...
export const autoWebhookSecretHeader = "x-auto-webhook-secret";
/** Seam D: internal worker service-key header (server-only). */
export const autoInternalServiceKeyHeader = "x-service-key";
// ---------------------------------------------------------------------------
// Route builders
// ---------------------------------------------------------------------------
...
export const autoRoutes = {
    ...
    revokeApproval: (id) => `/api/auto/approvals/${encodeURIComponent(id)}/revoke`,
    runs: () => "/api/auto/runs",
    run: (id) => `/api/auto/runs/${encodeURIComponent(id)}`,
    cancelRun: (id) => `/api/auto/runs/${encodeURIComponent(id)}/cancel`,
    runInputsUploadUrl: () => "/api/auto/runs/inputs/upload-url",
    schedules: () => "/api/auto/schedules",
    schedule: (id) => `/api/auto/schedules/${encodeURIComponent(id)}`,
    webhooks: () => "/api/auto/webhooks",
    webhook: (id) => `/api/auto/webhooks/${encodeURIComponent(id)}`
};
/** Seam B — Forge device-auth routes (/api/forge/auto/*, Bearer JWT). */
export const forgeAutoRoutes = {
    approvals: () => "/api/forge/auto/approvals",
    revokeApproval: (id) => `/api/forge/auto/approvals/${encodeURIComponent(id)}/revoke`,
    runs: () => "/api/forge/auto/runs",
    run: (id) => `/api/forge/auto/runs/${encodeURIComponent(id)}`,
    cancelRun: (id) => `/api/forge/auto/runs/${encodeURIComponent(id)}/cancel`,
    runInputsUploadUrl: () => "/api/forge/auto/runs/inputs/upload-url",
    schedules: () => "/api/forge/auto/schedules",
    schedule: (id) => `/api/forge/auto/schedules/${encodeURIComponent(id)}`,
    webhooks: () => "/api/forge/auto/webhooks",
    webhook: (id) => `/api/forge/auto/webhooks/${encodeURIComponent(id)}`
};
/** Seam C — public webhook ingest (per-webhook shared secret). */
export const autoHookRoutes = {
    ingest: (webhookId) => `/api/hooks/auto/${encodeURIComponent(webhookId)}`
};
